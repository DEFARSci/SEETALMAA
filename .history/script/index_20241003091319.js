...
async function fetchPageData() {
  try {
      ...
      // Section-trois
      displayTitle('title_un',0);
      displayContent('article_un',0);
      displayImage( 'img_un',0);

      // Section-trois 1
      displayTitle('title_deux',2);
      displayImage( 'img_deux',2);

      // Section-trois A_1
      displayTitle('title_a1',3);
      displayImage( 'img_a1',3);

       // Section-trois A_2
       displayTitle('title_a2',3);
       displayImage( 'img_a2',3);

        // Section-trois A_3
        displayTitle('title_a3',3);
        displayImage( 'img_a3',3);

        // Section-trois A_4
        displayTitle('title_a4',3);
        displayImage( 'img_a4',3);

        // Section-trois B
        displayTitle('title_b',3);
        displayImage( 'img_b',3);
        displayContent('article_b',0);

        // Section-trois C
        displayTitle('title_c',3);
        displayImage( 'img_c',3);
        displayContent('article_c',0);

        // Section-quatre
        displayTitle('title_quatre',4);
        displayContent('article_quatre',4);
        displayImage( 'img_quatre',4);

        // Section-quatre A
        displayTitle('title_4a',4);
        displayImage( 'img_4a',4);

        // Section-quatre B
        displayTitle('title_4b',4);
        displayImage( 'img_4b',4);

        // Section-quatre C
        displayTitle('title_4c',4);
        displayImage( 'img_4c',4);

        // Section-quatre D
        displayTitle('title_4d',4);
        displayImage( 'img_4d',4);

        // Section-quatre E
        displayTitle('title_4e',4);
        displayImage( 'img_4e',4);

        // Section-cinq
        displayTitle('title_cinq',5);
        displayContent('article_cinq',5);
        displayImage( 'img_cinq',5);

        //Section-cinq A
        displayTitle('title_5a',5);
        //Section-cinq B
        displayTitle('title_5b',5);
        //Section-cinq C
        displayTitle('title_5c',5);

        //Section-cinq D1
        displayTitle('title_5d1',5);
        displayImage( 'img_5d1',5);
        //Section-cinq D2
        displayTitle('title_5d2',5);
        displayImage( 'img_5d2',5);
        //Section-cinq D3
        displayTitle('title_5d3',5);
        displayImage( 'img_5d3',5);
        //Section-cinq D4
        displayTitle('title_5d4',5);
        displayImage( 'img_5d4',5);

        //Section-cinq E1
        displayTitle('title_5e1',5);
        displayImage( 'img_5e1',5);

        //Section-cinq E2
        displayTitle('title_5e2',5);

        //Section-cinq F1
        displayTitle('title_5f1',5);
        displayImage( 'img_5f1',5);
        
        //Section-cinq F2
        displayTitle('title_5f2',5);

        //Section-cinq G1
        displayTitle('title_5g1',5);
        displayImage( 'img_5g1',5);
        
        //Section-cinq G2
        displayTitle('title_5g2',5);
