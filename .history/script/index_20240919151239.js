...
async function fetchCategories(categoryIds) {
    try {
        ...
        console.log("Categories data:", categoriesData); // Vérifiez les catégories récupérées
        ...
        console.log("Selected categories:", selectedCategories); // Vérifiez les catégories sélectionnées
